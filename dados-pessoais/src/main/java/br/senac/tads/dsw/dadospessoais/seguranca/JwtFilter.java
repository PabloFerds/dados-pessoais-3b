...
public class JwtFilter extends OncePerRequestFilter {
	...
	protected void doFilterInternal(HttpServletRequest request,
		...
		try {
			// 1. Deriva a chave de 256 bits a partir do segredo (mesmo processo do JwtService)
		...
		// Independente do resultado da validação, a requisição continua a cadeia de filtros.
		// Se o usuário não foi autenticado e a rota exige autenticação, o SecurityConfig
